<?php
  ...
  $fish[15] = 'i.f.foo.fish_l_uklejka|1';
  $fish[20] = 'i.f.foo.fish_l_karasq|2';
  $fish[30] = 0;
  $fish[35] = 'i.f.foo.fish_l_krasnoperka|2';
  $fish[40] = 'i.f.foo.fish_l_linq|3';
  $fish[50] = 0;
  $fish[55] = 'i.f.foo.fish_l_okunq|4';
  $fish[60] = 'i.f.foo.fish_l_leshq|8';
  $fish[70] = 0;
  $fish[75] = 'i.f.foo.fish_l_wuka|12';
