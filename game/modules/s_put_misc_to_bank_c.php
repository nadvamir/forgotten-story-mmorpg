<?php
  // ukazatq chislo veshej, kotoryh nado polozhitq v bank
  ...
  $f .= '<input type="hidden" name="action" value="put_misc_to_bank"/>';
  ...
  $f .= '<input type="submit" value="положить"/></form>';
  $f .= '<br/>';
